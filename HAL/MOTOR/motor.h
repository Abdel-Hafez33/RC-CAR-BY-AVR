...
#define MOTOR1_PORTID				PORTB_ID
#define MOTOR1_IN1_PINID			PIN4_ID
#define MOTOR1_IN2_PINID			PIN0_ID

#define MOTOR2_PORTID				PORTB_ID
#define MOTOR2_IN1_PINID			PIN6_ID
#define MOTOR2_IN2_PINID			PIN7_ID
